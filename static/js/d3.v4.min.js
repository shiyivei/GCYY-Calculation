...
(function (t, n) {
  ...
  function d(t) {
    return (
      Math.ceil(Math.log(t.length) / Math.LN2) + 1
    );
  }
  function v(t, n, e) {
    if ((null == e && (e = i), (r = t.length))) {
      ...
      var r,
        ...
        a = +e(t[u], u, t);
      return (
        a + (+e(t[u + 1], u + 1, t) - a) * (o - u)
      );
    }
  }
  function g(t) {
    for (
      var n, e, r, i = t.length, o = -1, u = 0;
      ++o < i;
  ...
  function N() {
    for (
      var t, n = 0, e = arguments.length, r = {};
      n < e;
      ++n
    ) {
  ...
  function D(t, n, e, r, i, o) {
    for (
      var u, a = 0, c = n.length, s = o.length;
      a < s;
      ++a
    )
      (u = n[a])
    ...
    return (
      ...
      function (n) {
        ...
        (e &&
          (e === this ||
            8 &
              e.compareDocumentPosition(this))) ||
          t.call(this, n);
      }
    );
  }
  ...
  function dt(t, n, e) {
    arguments.length < 3 &&
      ((e = n), (n = lt().changedTouches));
    for (
      var r, i = 0, o = n ? n.length : 0;
      i < o;
      ++i
    )
  ...
  function Kn(n) {
    ...
    function u() {
      ...
      function u() {
        ...
        O.attr("pointer-events", "all"),
          ...
          S.selection && (A = S.selection),
          Jn(A) &&
            ((S.selection = null), r.call(w)),
          U.end();
      }
      if (t.event.touches) {
        if (
          t.event.changedTouches.length <
    ...
    function a() {
      ...
      return (
        (t.extent = s.apply(this, arguments)),
        (t.dim = n),
        t
      );
    }
        ...
        if (!((n = t.length - 1) <= 0)) {
          ...
          if (Hr(r, u)) {
            ...
            a.push((e = new jr(r, t, null, !0))),
              c.push(
                (e.o = new jr(r, null, e, !1))
              ),
              a.push(
                (e = new jr(u, t, null, !1))
              ),
              c.push(
                (e.o = new jr(u, null, e, !0))
              );
        }
      }),
      a.length)
  ...
  function fo(t, n) {
    ...
    for (null == n && (n = lo); (e = s.pop()); )
      if (
        ...
        for (
          e.children = new Array(u), o = u - 1;
          o >= 0;
          --o
        )
          s.push(
            (r = e.children[o] = new vo(i[o]))
          ),
            (r.parent = e),
            (r.depth = e.depth + 1);
  ...
  function ia(t, n, e) {
    ...
    return r
      ? ((t.Q = +r[0]), e + r[0].length)
      : -1;
  }
  function oa(t, n, e) {
    var r = Tg.exec(n.slice(e));
    return r
      ? ((t.Q = 1e3 * +r[0]), e + r[0].length)
      : -1;
  }
  function ua(t, n) {
  ...
  function $c(t) {
    ...
    for (
      ...
      (e = i[n] / o[n - 1]),
        ...
        (u[n] -= e * u[n - 1]);
    for (
      i[r - 1] = u[r - 1] / o[r - 1], n = r - 2;
      n >= 0;
      --n
    )
      i[n] = (u[n] - i[n + 1]) / o[n];
    for (
      o[r - 1] = (t[r] + i[r - 1]) / 2, n = 0;
      n < r - 1;
      ++n
    )
      o[n] = 2 * t[n + 1] - i[n + 1];
  ...
  function Ns(t, n) {
    ...
    if (
      ((function () {
        for (
          var t, n, e, r, i = 0, o = L_.length;
          i < o;
          ++i
        )
          if (
            (t = L_[i]) &&
            (r = (n = t.halfedges).length)
          ) {
            var u = new Array(r),
              a = new Array(r);
            for (e = 0; e < r; ++e)
  ...
  function Ds(t, n, e) {
    ...
    return t.translate(
      i > r
        ? (r + i) / 2
        : Math.min(0, r) || Math.max(0, i),
      u > o
        ? (o + u) / 2
        : Math.min(0, o) || Math.max(0, u)
    );
  }
  var Us = e(n),
    Os = Us.right,
  ...
  ut.prototype = at.prototype = {
    ...
    selectAll: function (t) {
      ...
      for (
        ...
        for (
          var u, a = n[o], c = a.length, s = 0;
          s < c;
          ++s
        )
          (u = a[s]) &&
            (r.push(t.call(u, u.__data__, s, a)),
            i.push(u));
      return new ut(r, i);
    },
    filter: function (t) {
    ...
    enter: function () {
      return new ut(
        this._enter || this._groups.map(L),
        this._parents
      );
    },
    exit: function () {
      return new ut(
        this._exit || this._groups.map(L),
        this._parents
      );
    },
    merge: function (t) {
    ...
    each: function (t) {
      for (
        var n = this._groups, e = 0, r = n.length;
        e < r;
        ++e
      )
        for (
          var i, o = n[e], u = 0, a = o.length;
          u < a;
          ++u
        )
          (i = o[u]) &&
            t.call(i, i.__data__, u, o);
      return this;
    },
    attr: function (t, n) {
      var e = E(t);
  ...
  Nt(St, Et, {
    ...
    Nt(
      ...
      kt(St, {
        ...
        rgb: function () {
          var t =
              (this.h % 360) + 360 * (this.h < 0),
            n =
              isNaN(t) || isNaN(this.s)
                ? 0
                : this.s,
            e = this.l,
            r = e + (e < 0.5 ? e : 1 - e) * n,
      ...
      function (t) {
        return null == t
          ...
          : (If ||
            ...
            (t =
              If.transform.baseVal.consolidate())
              ? ((t = t.matrix),
                hn(t.a, t.b, t.c, t.d, t.e, t.f))
              : Zf);
      },
      ", ",
      ")",
    ...
    (at.prototype.transition = function (t) {
      ...
      t instanceof qn
        ...
        : ((n = Un()),
          ...
          (t = null == t ? null : t + ""));
      for (
        var r = this._groups, i = r.length, o = 0;
        o < i;
        ++o
      )
        for (
      ...
      for (
        ...
        if (
          ...
          var s = (r + o) / 2,
            f = (i + u) / 2;
          (e = c[3]) &&
            a.push(new be(e, s, f, o, u)),
            (e = c[2]) &&
              a.push(new be(e, r, f, s, u)),
            (e = c[1]) &&
              a.push(new be(e, s, i, o, f)),
            (e = c[0]) &&
              a.push(new be(e, r, i, s, f));
        }
      return this;
    }),
      ...
      for (
        ...
        if (i.length) {
          var o,
            ...
            l = (a + s) / 2;
          (o = i[0]) &&
            e.push(new be(o, u, a, f, l)),
            (o = i[1]) &&
              e.push(new be(o, f, a, c, l)),
            (o = i[2]) &&
              e.push(new be(o, u, l, f, s)),
            (o = i[3]) &&
              e.push(new be(o, f, l, c, s));
        }
        r.push(n);
      }
      for (; (n = r.pop()); )
  ...
  var Mv = wv.range,
    ...
    Cv = Cu(
      function (t) {
        var n =
          (t.getTimezoneOffset() * Tv) % 36e5;
        n < 0 && (n += 36e5),
          t.setTime(
            36e5 * Math.floor((+t - n) / 36e5) + n
          );
      },
      function (t, n) {
        t.setTime(+t + 36e5 * n);
  ...
  var a_ = Array.prototype.slice,
    ...
    p_ =
      Math.sin(r_ / 10) / Math.sin((7 * r_) / 10),
  ...
  (Es.prototype = Ss.prototype),
    ...
    (t.thresholdFreedmanDiaconis = function (
      t,
      e,
      r
    ) {
        ...
        if (a) {
          ...
          for (
            ...
            ((e = t[n]).index = n),
              ...
              (c[e.source.index] =
                (c[e.source.index] || 0) + 1),
              (c[e.target.index] =
                (c[e.target.index] || 0) + 1);
          for (
            n = 0, s = new Array(h);
            n < h;
            ++n
    ...
    (t.geoBounds = function (t) {
      ...
      if (
        ...
        for (
          ip.sort(xr), n = 1, o = [(r = ip[0])];
          n < e;
          ++n
        )
          br(r, (i = ip[n])[0]) || br(r, i[1])
            ? (mr(r[0], i[1]) > mr(r[0], r[1]) &&
                (r[1] = i[1]),
              mr(i[0], r[1]) > mr(r[0], r[1]) &&
                (r[0] = i[0]))
            : o.push((r = i));
        for (
          u = -1 / 0,
        ...
        return (
          ...
          n
            ...
            : t
                ...
                .eachAfter(Po(Eo, 1))
                .eachAfter(
                  Po(i, t.r / Math.min(e, r))
                )
                .eachBefore(
                  Ro(Math.min(e, r) / (2 * t.r))
                ),
          t
        );
      }
    ...
    (t.create = function (t) {
      return ct(
        A(t).call(document.documentElement)
      );
    }),
    (t.creator = A),
    (t.local = st),
